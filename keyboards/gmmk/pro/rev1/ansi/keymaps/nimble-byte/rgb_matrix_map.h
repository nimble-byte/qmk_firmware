/* Copyright 2021 Jonavin Eng @Jonavin
   Copyright Til Goepfert (@nimble-byte)
...
#define RGB_CUSTOM_CYAN 0x00, 0xE4, 0xFF
#define RGB_BORDEAUX 0x42, 0x00, 0x00
#define RGB_DMAGENTA 0x8B, 0x00, 0x8B // Dark Magenta

#define RBG_OFF RGB_BLACK
...
enum led_location_map {
    ...
    LED_L1, // 67, LED, l01
    LED_R1, // 68, LED, l11
    LED_HOME, // 69, Prt, k97  -- remapped to INS
    LED_L2, // 70, LED, l02
    LED_R2, // 71, LED, l12
    LED_DEL, // 72, Del, k65
    LED_L3, // 73, LED, l03
...
// added for easy CAPS / NUM lock indicators
const uint8_t LED_SIDES_UPPER[] = {
    LED_L1,
    LED_L2,
    LED_L3,
    LED_L4,
